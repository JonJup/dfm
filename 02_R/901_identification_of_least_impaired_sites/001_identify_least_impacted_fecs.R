...
# date last modified: 24.05.22
# Project: Evaluating European Broad River Types for Diatoms, Fish and Macrophytes
# Purpose: Define least impacted rivers with lemm et al 2021 data. 
...
rm(x)
# load data -------------------------------------------------------------------------
data  <- st_read("~/../Desktop/lemm/MultipleStress_RiverEcoStatus.shp")
...
for (i in seq_along(theshold_vector)){
        ...
        # bad     <- frequencies[V1 == "bad" & V2 == TRUE, N]/(frequencies[V1 == "bad" & V2 == TRUE, N] + frequencies[V1 == "bad" & V2 == FALSE, N]) 
        # poor    <- frequencies[V1 == "poor" & V2 == TRUE, N]/(frequencies[V1 == "poor" & V2 == TRUE, N] + frequencies[V1 == "poor" & V2 == FALSE, N]) 
        # moderate <- frequencies[V1 == "moderate" & V2 == TRUE, N]/(frequencies[V1 == "moderate" & V2 == TRUE, N] + frequencies[V1 == "moderate" & V2 == FALSE, N]) 
        # good    <- frequencies[V1 == "good" & V2 == TRUE, N]/(frequencies[V1 == "good" & V2 == TRUE, N] + frequencies[V1 == "good" & V2 == FALSE, N]) 
        # high    <- frequencies[V1 == "high" & V2 == TRUE, N]/(frequencies[V1 == "high" & V2 == TRUE, N] + frequencies[V1 == "high" & V2 == FALSE, N])
...
# save to file  ---------------------------------------------------------------------
st_write(data4, "data/lemm_least_impacted.gpkg")
