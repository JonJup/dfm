...
bio_wd <- "data/diatoms/original_data/germany_lower_saxony/raw/200918_WRRL-Monitoring_NLWKN_2008-2018_Dia.xlsx"
sit_wd <- "data/diatoms/original_data/germany_lower_saxony/raw/200918_WRRL-Monitoring_NLWKN_2008-2018_Proben_Stammdaten.xlsx"
...
## which variable is best to link bio with sit? 
sum(bio$PrMstID %in% sit$PrMstID)/nrow(bio)
...
rl <- readRDS("data/diatoms/original_data/germany_lower_saxony/2022-01-25_remove_list.rds")
...
saveRDS(updated_type, paste0("data/diatoms/original_data/germany_lower_saxony/", Sys.Date(), "_updated_type.rds"))
...
saveRDS(data10, paste0("data/diatoms/original_data/germany_lower_saxony/",Sys.Date(),"_final_aggregated.rds"))
