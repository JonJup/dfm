...
bio_wd <- "data/diatoms/original_data/germany_hesse/raw/untersuchung_dia_2005-2019.xlsx"
sit_wd <- "data/diatoms/original_data/germany_hesse/raw/Messstellen.xlsx"
...
rl <- readRDS("data/diatoms/original_data/germany_hesse/2022-01-25_remove_list.rds")
...
saveRDS(updated_type, paste0("data/diatoms/original_data/germany_hesse/", Sys.Date(), "_updated_type.rds"))
...
saveRDS(data10, paste0("data/diatoms/original_data/germany_hesse/",Sys.Date(),"_final_aggregated.rds"))
