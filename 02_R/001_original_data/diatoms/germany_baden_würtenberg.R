# ———————————————————————————————————————————————— #
# ——— Clean Diatom data from Baden Wurttemberg ——— # 
# ———————————————————————————————————————————————— #

# ———————————————————————————————————
# date first written: 21-12-10
...
# raw data from Germany Baden Wurttemberg  
...
bio_wd <- "data/diatoms/original_data/germany_baden_wuertenberg/raw/Taxalisten_MuP_alle_Ergebnistabelle_BJ_2021.xlsx"
sit_wd <- "data/diatoms/original_data/germany_baden_wuertenberg/raw/WRRL-Monitoring_MuP_2015-17_Stand_2021-03-23.xlsx"
...
# taxontable <- append_to_tt("Achnanthes acares Hohn & Hellerman","Achnanthes acares")
# join 
...
rl <- readRDS("data/diatoms/original_data/germany_baden_wuertenberg/2022-01-25_remove_list.rds")
...
saveRDS(updated_type, paste0("data/diatoms/original_data/germany_baden_wuertenberg/", Sys.Date(), "_updated_type.rds"))
...
saveRDS(data10, paste0("data/diatoms/original_data/germany_baden_wuertenberg/",Sys.Date(),"_final_aggregated.rds"))
