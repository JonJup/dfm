...
data <- readRDS("data/diatoms/combined_data/01_2022-05-03_combined_data_aggregated.rds")
unique(data$data.set) |> sort()
data <- data[data.set == "slovakia_monitoring_macrophytes"]
data_name <- "diatom_slovakia_monitoring"


drop_id <- c(
        "site_00163_date_00076_slovakian_monitoring_diatoms",
        "site_00169_date_00023_slovakian_monitoring_diatoms"
)
