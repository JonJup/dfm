...
# Purpose: Post Clean Check for diatom data from German Federal State Baden Wuertemberg 
# Notes: 
# -------------------------------
...
data <- readRDS("data/diatoms/original_data/germany_baden_wuertenberg/2022-01-25_final_aggregated.rds")
unique(data$brt12)

data_name <- "diatom_baden_wuertemberg"

data <- data[!gr_sample_id %in% "site_00266_date_00071_germany_baden_wurttemberg_diatoms"]
