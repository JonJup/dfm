...
# Purpose: Post Clean Check for diatom data from German Federal Lower Saxony
# Notes: 
# -------------------------------
...
data <- data[data.set == "portugal_monitoring_diatom"]

data_name <- "diatom_portugal_monitoring"

# data <- data[!gr_sample_id %in% c("site_00505_date_00173_germany_saxony_diatoms", "site_00109_date_00093_germany_landau_diatoms",
#                                   "site_00051_date_00060_germany_landau_diatoms", "site_00073_date_00074_germany_landau_diatoms")]
