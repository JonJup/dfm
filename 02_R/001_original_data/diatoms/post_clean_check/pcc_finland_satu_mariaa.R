...
# date last modified: 28.03.22
# Project: Evaluating European Broad River Types for Diatoms, Fish and Macrophytes
# Purpose: Post Clean Check for diatom data from Finland provided by Satu Maaria Karjalainen
# Notes: 
# -------------------------------
...
data <- readRDS("data/diatoms/combined_data/01_2022-03-28_combined_data_aggregated.rds")
unique(data$data.set) |> sort()
data <- data[data.set == "finland_monitoring_diatom"]
data_name <- "diatom_finland_satu_maaria"
...
# 
# saveRDS(lcbd, "data/temp/uk_lcbd.rds")
