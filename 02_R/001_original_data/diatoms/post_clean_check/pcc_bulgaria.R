...
# Purpose: Post Clean Check for diatom data from Bulgaria
# Notes: 
# -------------------------------
...
data <- readRDS("data/diatoms/combined_data/01_2022-04-22_combined_data_aggregated.rds")
unique(data$data.set) |> sort()
data <- data[data.set == "bulgaria_monitoring_diatom"]
data_name <- "diatom_bulgaria_monitoring"
