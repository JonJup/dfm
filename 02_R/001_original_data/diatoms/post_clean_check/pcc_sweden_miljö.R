...
#       date written: 18.05.22
# date last modified: 18.05.22
#            Project: Evaluating European Broad River Types for Diatoms, Fish and Macrophytes
#            Purpose: Post Clean Check for diatom data frm Miljödata Sweden
...
data <- readRDS("data/diatoms/combined_data/01_2022-05-18_combined_data_aggregated.rds")
unique(data$data.set) |> sort()
data <- data[data.set == "sweden_monitoring_diatoms"]
data_name <- "diatom_sweden_miljö"
