...
# Purpose: Post Clean Check for diatom data from Greece monitoring data
# Notes: 
# -------------------------------
...
data <- readRDS("data/diatoms/combined_data/01_2022-03-04_combined_data_aggregated.rds")
data <- rbindlist(data)
unique(data$data.set) |> sort()
data <- data[data.set == "greece_monitoring_diatom"]

data_name <- "diatom_greece_monitoring"
