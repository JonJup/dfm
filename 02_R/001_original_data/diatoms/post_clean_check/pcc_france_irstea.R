...
# Purpose: Post Clean Check for diatom data from IRSTEA France
# Notes: 
# -------------------------------
...
data <- readRDS("data/diatoms/original_data/french_irstea//2022-01-21_final_aggregated.rds")

data[brt12 == "\"RT08\"", brt12 := "RT08"]
data[brt12 == "\"RT03\"", brt12 := "RT03"]
data[brt12 == "\"RT02\"", brt12 := "RT02"]
data[brt12 == "\"RT11\"", brt12 := "RT11"]
data[brt12 == "\"RT01\"", brt12 := "RT01"]

#data <- saveRDS(data, "data/diatoms/original_data/french_irstea//2022-01-21_final_aggregated.rds")


unique(data$brt12)

data_name <- "diatom_irstea"

## drop sites (not enough or too many entries after dropping species NAs)
drop_sites <- c("site_00010_date_00001_france_irstea_diatoms",
...
data <- data[!gr_sample_id %in% drop_sites]
...
## RESULST NMDS 
## There is one remarkable site in RT10. 
nmds.j[[1]][x < -0.5]

data2 |> 
#        filter(gr_sample_id == "site_00012_date_00003_france_irstea_diatoms") |> 
        select(!c("gr_sample_id", "brt12", "season")) |> 
        rowSums() |> 
        sort() |> plot()
