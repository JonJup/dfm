# —————————————————————————————————————————————————————— #
# ——— Clean macrophyte data from Germany lower saxony ——— # 
# —————————————————————————————————————————————————————— #
...
bio_wd <- "data/macrophytes/original_data/germany_lowersaxony/raw/200918_WRRL-Monitoring_NLWKN_2008-2018_Mph.xlsx"
sit_wd <- "data/macrophytes/original_data/germany_lowersaxony/raw/200918_WRRL-Monitoring_NLWKN_2008-2018_Proben_Stammdaten.xlsx"
...
bio <- bio[, c("PrMstID", "PrDatum", "TaxTaxon")]
## drop columns from sit 
sit <- sit[,c("PrMstID", "MstUTMx", "MstUTMy")]
sit <- unique(sit, on = "PrMstID")
## join data 
data <- sit[bio, on = "PrMstID"]
...
## add gr_sample_id
data2[,gr_sample_id := paste0("site_", site_id, "_date_", date_id,"_germany_lowersaxony_macrophytes")]
...
data3 <- data2[, list(
        ...
        y.coord,
        EPSG,
        data.set = "germany_lowersaxony_macrophytes"
)]
...
rl <- readRDS("data/macrophytes/original_data/germany_lowersaxony/2022-01-27_remove_list.rds")
...
saveRDS(updated_type, paste0("data/macrophytes/original_data/germany_lowersaxony/", Sys.Date(), "_updated_type.rds"))
...
saveRDS(data10, paste0("data/macrophytes/original_data/germany_lowersaxony/",Sys.Date(),"_final_aggregated.rds"))
