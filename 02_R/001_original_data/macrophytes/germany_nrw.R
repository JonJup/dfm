# —————————————————————————————————————————————— #
# ——— Clean macrophyte data from Germany NRW ——— # 
# —————————————————————————————————————————————— #

# ———————————————————————————————————
# date first written: 07-12-21
...
# raw data from Germany NRW.  
# CRS: ETRS89 / UTM zone 32N ——— 25832 
# ————————————————
...
bio_wd <- "data/macrophytes/original_data/germany_nrw/raw/Mak_PPL_ab2016.xlsx"
...
# taxontable[original_name == "Sium", taxon_state := "drop"]

# taxontable[clean == FALSE]
# taxontable <- fill_taxon_table(o = "Pellia / Aneura pinguis",
#                                s = "Aneura pinguis",
#                                g = "Aneura",
#                                f = "Aneuraceae",
#                                or = "Metzgeriales",
...
#                                p = "Marchantiophyta", 
#                                k = "Plantae")
# taxontable <- fill_taxon_table(o = "Sagittaria",
#                                g = "Sagittaria",
#                                f = "Alismataceae",
#                                or = "Alismatales",
#                                c = "Liliopsida", 
...
## add gr_sample_id
data2[,gr_sample_id := paste0("site_", site_id, "_date_", date_id,"_germany_nrw_macrophytes")]
...
data3 <- data2[, list(
        ...
        y.coord,
        EPSG,
        data.set = "germany_nrw_macrophytes"
)]
...
saveRDS(updated_type, paste0("data/macrophytes/original_data/germany_nrw/", Sys.Date(), "_updated_type.rds"))
...
saveRDS(data10, paste0("data/macrophytes/original_data/germany_nrw/",Sys.Date(),"_final_aggregated.rds"))
