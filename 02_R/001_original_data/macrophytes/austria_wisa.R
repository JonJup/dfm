# —————————————————————————————————————————————————— #
# ——— Clean macrophyte data from Austria WISA DB ——— # 
# —————————————————————————————————————————————————— #

# date first written: 01.12.21
...
# raw data provided by the WISA DB, Asutria.  
# Temporal aggregation: No
# CRS: MGI / Austria GK M31 ; EPSG: 31258
...
bio_wd <- "data/macrophytes/original_data/austria/raw/WISADatenabfrage_20211201_1359.xlsx"
...
names(bio)
names(bio)[c(3,6,11,16)] <- c("original_site_name", "date", "parameter", "taxon")
bio <- bio[parameter == "MPH Aufnahme Artenliste"]
bio <- bio[, c("original_site_name", "date", "parameter", "taxon")]

names(sit)[c(3,21,24)] <- c("original_site_name", "y.coord", "x.coord")
sit <- sit[,  c("original_site_name", "y.coord", "x.coord")]
...
st_as_sf(sites, coords = c("x.coord", "y.coord"), crs = 31258) |> mapview::mapview()
...
# 
# 
# taxontable <- fill_taxon_table(o = "Najas marina subsp. intermedia",
#                                s = "Najas marina",
#                                g = "Najas",
#                                f = "Hydrocharitaceae",
#                                or = "Alismatales",
...
## add gr_sample_id
data2[,gr_sample_id := paste0("site_", site_id, "_date_", date_id,"_austira_wisa_macrophytes")]
...
data6 |> unique(by = "gr_sample_id") %$% table(richness)
data7 <- data6#data6[richness > 10]

# - drop sites far removed from ECRINS river network 
data8 <- data7[distance < 300]
rl <- readRDS("data/macrophytes/original_data/austria/2022-01-27_remove_list.rds")
...
saveRDS(updated_type, paste0("data/macrophytes/original_data/austria/", Sys.Date(), "_updated_type.rds"))
...
saveRDS(data10, paste0("data/macrophytes/original_data/austria/",Sys.Date(),"_final_aggregated.rds"))
