# —————————————————————————————————————————————————————— #
# ——— Clean macrophyte data from Germany brandenburg ——— # 
# —————————————————————————————————————————————————————— #
...
bio_wd  <- "data/macrophytes/original_data/germany_brandenburg/raw/Biologische_Daten_Messstellen.xlsx"
...
bio <- bio[Komponente == "Makrophyten"]
...
# taxontable[taxon_state == "Ranunculus"]
# taxontable[genus == "Rumex"]
# taxontable[original_name == "Epilobium spec.", taxon_state := "drop"]
# taxontable[original_name == "Juncus spec.", taxon_state := "helophytes"]
# taxontable[original_name == "Nasturtium spec.", taxon_state := "helophytes"]
# taxontable[original_name == "Ranunculus spec. (aquatisch)", taxon_state := "hydrophytes"]
# taxontable[original_name == "Rumex spec.", taxon_state := "drop"]
...
## add gr_sample_id
data2[,gr_sample_id := paste0("site_", site_id, "_date_", date_id,"_germany_brandenburg_macrophytes")]
...
data3 <- data2[, list(
        ...
        y.coord,
        EPSG,
        data.set = "germany_brandenburg_macrophytes"
)]
...
rl <- readRDS("data/macrophytes/original_data/germany_brandenburg/2022-01-27_remove_list.rds")
...
saveRDS(updated_type, paste0("data/macrophytes/original_data/germany_brandenburg/", Sys.Date(), "_updated_type.rds"))
...
saveRDS(data10, paste0("data/macrophytes/original_data/germany_brandenburg/",Sys.Date(),"_final_aggregated.rds"))
