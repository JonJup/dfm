# ———————————————————————————————————————————————————— #
# ——— Clean macrophyte data from Germany: Saxony ————— # 
# ———————————————————————————————————————————————————— #

# ———————————————————————————————————
# date first written: 13-01-22
...
bio_wd <- "data/macrophytes/original_data/germany_saxony/raw/Artenliste-Makrophyten_BWPL_2021/"
...
## add gr_sample_id
data2[,gr_sample_id := paste0("site_", site_id, "_date_", date_id,"_germany_saxony_macrophytes")]
...
data3 <- data2[, list(
        ...
        y.coord,
        EPSG = 25833,
        data.set = "germany_saxony_macrophytes"
)]
...
rl <- readRDS("data/macrophytes/original_data/germany_saxony/2022-01-27_remove_list.rds")
...
saveRDS(updated_type, paste0("data/macrophytes/original_data/germany_saxony/", Sys.Date(), "_updated_type.rds"))
updated_type <- readRDS("data/macrophytes/original_data/germany_saxony/2022-06-13_updated_type.rds")
...
saveRDS(data10, paste0("data/macrophytes/original_data/germany_saxony/",Sys.Date(),"_final_aggregated.rds"))
