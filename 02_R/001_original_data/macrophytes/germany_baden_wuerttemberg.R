...
bio_wd <- "data/macrophytes/original_data/germany_baden_wuerttemberg/raw/Taxalisten_MuP_alle_Ergebnistabelle_BJ_2021.xlsx"
sit_wd <- "data/macrophytes/original_data/germany_baden_wuerttemberg/raw/WRRL-Monitoring_MuP_2015-17_Stand_2021-03-23.xlsx"
...
saveRDS(updated_type, paste0("data/macrophytes/original_data/germany_baden_wuerttemberg/", Sys.Date(), "_updated_type.rds"))
...
saveRDS(data10, paste0("data/macrophytes/original_data/germany_baden_wuerttemberg/",Sys.Date(),"_final_aggregated.rds"))
