...
# Purpose: Post Clean Check for macrophytes data from Germany Brandenburg
# Notes: 
# -------------------------------
...
data <- data[data.set == "germany_brandenburg_macrophytes"]

data_name <- "macrophyte_germany_brandenburg"
