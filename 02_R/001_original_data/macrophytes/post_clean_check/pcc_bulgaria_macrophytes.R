...
# -------------------------------
# date written: 16.03.22
# date last modified: 16.03.22
# Project: Evaluating European Broad River Types for Diatoms, Fish and Macrophytes
# Purpose: Post Clean Check for macrophytes data from Bulgaria provided by Gana 
# Notes: 
# -------------------------------
...
# load data -------------------------------------------
data <- readRDS("data/macrophytes/combined_data/01_2022-03-17_combined_data_aggregated.rds")
unique(data$data.set) |> sort()
data <- data[data.set == "bulgaria_gana_macrophytes"]

data_name <- "macrophyte_bulgaria_gana"
