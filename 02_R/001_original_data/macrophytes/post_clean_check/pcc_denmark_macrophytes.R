...
# -------------------------------
# date written: 26.04.22
# date last modified: 26.04.22
# Project: Evaluating European Broad River Types for Diatoms, Fish and Macrophytes
# Purpose: Post Clean Check for macrophytes data from Denmark
# -------------------------------
...
# load data -------------------------------------------
data <- readRDS("data/macrophytes/combined_data/01_2022-04-26_combined_data_aggregated.rds")
unique(data$data.set) |> sort()
data <- data[data.set == "denmark_monitoring_macrophytes"]

data_name <- "macrophytes_denmark"
