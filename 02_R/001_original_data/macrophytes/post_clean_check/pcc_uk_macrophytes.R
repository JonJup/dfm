...
# Purpose: Post Clean Check for macrophytes data from UK
# Notes: 
# -------------------------------
...
data <- data[data.set == "uk_ee_macrophytes"]

data_name <- "macrophyte_uk_monitoring"

## extreme outlier in species NMDS 
data <- data[!gr_sample_id %in% c("site_00430_date_00030_uk_ee_macrophytes", 
