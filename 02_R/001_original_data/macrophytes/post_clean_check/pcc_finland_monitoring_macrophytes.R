...
# Purpose: Post Clean Check for macrophytes data from Austria WISA
# Notes: 
# -------------------------------
...
data <- data[data.set == "finland_monitoring_macrophytes"]

data_name <- "macrophyte_finland_monitoring"
