...
# Purpose: Post Clean Check for macrophytes data from Germany_baden_wuerttemberg
# Notes: 
# -------------------------------
...
data <- data[data.set == "germany_baden_wuerttemberg_macrophytes"]

data_name <- "macrophyte_germany_baden_wuerttemberg"
