...
# Purpose: Post Clean Check for macrophytes data from Lithuania
# -------------------------------
...
# load data -------------------------------------------
data <- readRDS("data/macrophytes/combined_data/01_2022-03-28_combined_data_aggregated.rds")
unique(data$data.set) |> sort()
data <- data[data.set == "lithuania_monitroing_macrophytes"]

data_name <- "macrophyte_lithuania_monitoring"
