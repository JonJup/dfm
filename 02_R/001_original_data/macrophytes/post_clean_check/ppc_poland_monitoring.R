...
# date last modified: 24.03.22
# Project: Evaluating European Broad River Types for Diatoms, Fish and Macrophytes
# Purpose: Post Clean Check for macrophytes data from Poland provided by Piotr 
# Notes: 
# -------------------------------
...
# load data -------------------------------------------
data <- readRDS("data/macrophytes/combined_data/01_2022-03-24_combined_data_aggregated.rds")
unique(data$data.set) |> sort()
data <- data[data.set == "poland_monitoring_macrophytes"]

data_name <- "macrophyte_poland_monitoring"
