...
# Purpose: Post Clean Check for macrophytes data from Germany Mecklenburg
# Notes: 
# -------------------------------
...
data <- data[data.set == "germany_mecklenburg_macrophytes"]

data_name <- "macrophyte_germany_mecklenburg"
