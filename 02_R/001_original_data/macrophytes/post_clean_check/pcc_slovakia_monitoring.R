...
# Purpose: Post Clean Check for macrophytes data from Slovakia
# -------------------------------
...
# load data -------------------------------------------
data <- readRDS("data/macrophytes/combined_data/01_2022-04-22_combined_data_aggregated.rds")
unique(data$data.set) |> sort()
data <- data[data.set == "slovakia_monitroing_macrophytes"]

data_name <- "macrophyte_slovakia_monitoring"
