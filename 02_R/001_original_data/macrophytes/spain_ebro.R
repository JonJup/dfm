...
bio_wd <- "data/macrophytes/original_data/spain_ebro/raw/WCASF_20211119105444.xlsx"
...
rl <- readRDS("data/macrophytes/original_data/spain_ebro/2022-01-27_remove_list.rds")
...
saveRDS(updated_type, paste0("data/macrophytes/original_data/spain_ebro/", Sys.Date(), "_updated_type.rds"))
...
saveRDS(data10, paste0("data/macrophytes/original_data/spain_ebro/",Sys.Date(),"_final_aggregated.rds"))
