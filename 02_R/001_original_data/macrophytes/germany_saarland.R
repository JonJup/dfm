# ——————————————————————————————————————————————————— #
# ——— Clean macrophyte data from Germany Saarland ——— # 
# ——————————————————————————————————————————————————— #

# ———————————————————————————————————
# date first written: 09-12-21
...
## add gr_sample_id
data2[,gr_sample_id := paste0("site_", site_id, "_date_", date_id,"_germany_saarland_macrophytes")]
...
data3 <- data2[, list(
        ...
        y.coord,
        EPSG,
        data.set = "germany_saarland_macrophytes"
)]
...
saveRDS(remove_list, paste0("data/macrophytes/original_data/french_naiades/", Sys.Date(), "_remove_list.rds"))
...
data10
saveRDS(data10, paste0("data/macrophytes/original_data/french_naiades/",Sys.Date(),"_final_aggregated.rds"))
