...
# date last modified: 25.04.22
# Project: Evaluating European Broad River Types for Diatoms, Fish and Macrophytes
# Purpose: Post Clean Check for Fish data from the inter calibration data- 
# Notes: 
# -------------------------------
...
# load data -------------------------------------------
data <- readRDS("data/fish/combined_data/01_2022-04-25_combined_data_aggregated.rds")
unique(data$data.set) |> sort()
data <- data[data.set == "intercalibration_fish"]

data_name <- "fish_intercalibration"
