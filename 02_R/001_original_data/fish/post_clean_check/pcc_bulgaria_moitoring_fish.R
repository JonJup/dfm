...
# date last modified: 07.03.22
# Project: Evaluating European Broad River Types for Diatoms, Fish and Macrophytes
# Purpose: Post Clean Check for Fish data from Bulgaria Moitoring
# Notes: 
# -------------------------------
...
# load data -------------------------------------------
data <- readRDS("data/fish/combined_data/01_2022-03-07_combined_data_aggregated.rds")
data <- rbindlist(data)
unique(data$data.set) |> sort()
data <- data[data.set == "bulgaria_monitoring_fish"]

data_name <- "fish_bulgaria_monitoring"
