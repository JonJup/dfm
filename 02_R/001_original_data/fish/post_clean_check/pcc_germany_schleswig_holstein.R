...
# Purpose: Post Clean Check for Fish data from Germany Lower Saxony
# Notes: 
# -------------------------------
...
data <- data[data.set == "germany_schleswig_holstein_fish"]

data_name <- "fish_germany_schleswig_holstein"
