...
# Purpose: Post Clean Check for Fish data from Portugal Monitoring
# Notes: 
# -------------------------------
...
# load data -------------------------------------------
data <- readRDS("data/fish/combined_data/01_2022-04-22_combined_data_aggregated.rds")
unique(data$data.set) |> sort()
data <- data[data.set == "portugal_monitoring_fish"]

data_name <- "fish_portugal_monitoring"
