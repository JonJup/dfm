...
# load data -------------------------------------------
bio <- read_excel("data/fish/original_data/finland_tapio/raw/JonathanJupke.xlsx")
...
sites <- sf$st_as_sf(sites, coords = c("x.coord", "y.coord"), crs = data$EPSG[1])
mapview(sites)
...
updated_type_old <- readRDS("data/fish/original_data/finland_tapio/2022-03-23_updated_type.rds")

## how many sites in data8: 217
uniqueN(data8$site_id)
## sites covered in updated_type_old: 214  
...
saveRDS(updated_type_combi, paste0("data/fish/original_data/finland_tapio/", Sys.Date(), "_updated_type_combi.rds"))
#updated_type <- readRDS("data/fish/original_data/finland_tapio/2022-03-23_updated_type.rds")
...
# yes 
data9 <- data9[, month := lubridate::month(date)]
...
# - save to file 
saveRDS(data10, paste0("data/fish/original_data/finland_tapio/",Sys.Date(),"_final_aggregated.rds"))
