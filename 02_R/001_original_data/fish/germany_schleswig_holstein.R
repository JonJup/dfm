# —————————————————————————————————————————————————————————— #
# ——— Clean fish data from Germany - Schleswig-Holstein  ——— # 
# —————————————————————————————————————————————————————————— #

# ———————————————————————————————————
# date first written: 21-11-24
...
# load data -------------------------------------------------------------------------
bio_wd  <- "data/fish/original_data/germany_schleswig_holstein/raw/Fische_2015-2019-Fruhling2020.xlsx"
...
data <- 
        data.table(
                original_site_name = bio$`Messstelle Nr.`,
                x.coord = bio$`UTM 32-East FIS`,
                y.coord = bio$`UTM 32-North FIS`,
                date = dmy(bio$Datum), 
...
## add gr_sample_id
data2[,gr_sample_id := paste0("site_", site_id, "_date_", date_id,"_", "germany_schleswig_holstein_fish")]
...
data3 <- data2[, list(
        ...
        y.coord,
        EPSG,
        data.set = "germany_schleswig_holstein_fish"
)]
...
remove_list <- readRDS("data/fish/original_data/germany_schleswig_holstein/2022-01-26_remove_list.rds")
...
saveRDS(updated_type, paste0("data/fish/original_data/germany_schleswig_holstein/", Sys.Date(), "_updated_type.rds"))
...
saveRDS(data10, paste0("data/fish/original_data/germany_schleswig_holstein/",Sys.Date(),"_final_aggregated.rds"))
