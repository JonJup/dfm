...
# load data -------------------------------------------
data <- readRDS("data/diatoms/combined_data/02_2022-12-12_w_null_model.rds")
...
# save data -------------------------------------------
saveRDS(data2, file = paste0("data/diatoms/combined_data/03_",Sys.Date(),"_no_rare_taxa.rds"))
