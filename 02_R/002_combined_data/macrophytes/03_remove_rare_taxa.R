...
### log files ---- 
sink(file = paste0("R/analyses/log_files/macrophytes_remove_rare_taxa", "_", Sys.Date(), "_", "log.txt"))
documentPath()
sessionInfo()
sink(file = NULL)
### --------------
...
# load data -------------------------------------------
data <- readRDS("data/macrophytes/combined_data/02_2022-12-12_w_null_model.rds")
...
# save data -------------------------------------------
saveRDS(data2, file = paste0("data/macrophytes/combined_data/03_",Sys.Date(),"_no_rare_taxa.rds"))
