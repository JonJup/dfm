...
# last change : analysis for multiple null models
...
### log files ---- 
sink(file = paste0("02_R/999_log_files/classification_strength_", Sys.Date(), "_", "log.txt"))
...
diatoms     <- readRDS("01_data/001_diatoms/002_combined_data/03_2022-12-12_no_rare_taxa.rds")
fishes      <- readRDS("01_data/002_fish/002_combined_data/03_2022-12-12_no_rare_taxa.rds")
macrophytes <- readRDS("01_data/003_macrophytes/002_combined_data/03_2022-12-12_no_rare_taxa.rds")
...
saveRDS(res, paste0("01_data/004_results/",Sys.Date(),"_classification_strength.rds"))
